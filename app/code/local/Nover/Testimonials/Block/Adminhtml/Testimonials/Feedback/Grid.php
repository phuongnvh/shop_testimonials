 ...
 * PYCOGROUP
 * Author: phuong.nvh
 * Testimonials Feedback Grid Block
 */

class Nover_Testimonials_Block_Adminhtml_Testimonials_Feedback_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    ...
    {
        $collection = Mage::getModel('testimonials/feedback')->getCollection();
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn(
            'username',
            array(
                'header' => Mage::helper('testimonials')->__('User'),
                'align'  => 'left',
                'index'  => 'username',
            )
        );
        ...
        $this->addColumn(
            ...
            array(
                ...
                'options' => array(
                    ...
                    1 => Mage::helper('testimonials')->__('Pending'),
                    2 => Mage::helper('testimonials')->__('Approved'),
                ),
            )
        );
    ...
    protected function _prepareMassaction()
    {
        ...
        $this->getMassactionBlock()->setFormFieldName('feedbacks');

        $statuses = Mage::getSingleton('testimonials/feedback_status')->getOptionArray();
        ...
        $this->getMassactionBlock()->addItem(
            'delete',
            array(
                'label'      => Mage::helper('testimonials')->__('Remove Feedback(s)'),
